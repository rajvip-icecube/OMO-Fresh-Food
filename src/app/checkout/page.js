...
export default function CheckoutPage() {
  ...
  const handlePlaceOrder = async (e) => {
    ...
    const orderData = {
      payment_method: "visa",
      payment_method_title: "Payed with Card",
      set_paid: false,
      billing: {
  ...
  const amount =(totalSubtotal + 12 + 7.56).toFixed(2)
  ...
  return (
    <>
                    ...
                    <div classNameName="col-12 col-md-5 col-lg-4 col-right">
                      <div classNameName="bg-primary text-white right-box">
                        <div classNameName="heading-wrap">
                          <h3 id="order_review_heading" classNameName="fs-2">
                            Your order
                          </h3>
                        </div>
                        ...
                        <div
                          id="order_review"
                          classNameName="woocommerce-checkout-review-order"
                        >
                          <table classNameName="shop_table woocommerce-checkout-review-order-table">
                            ...
                            <tbody>
                              {cartItems.map((item, index) => (
                                <tr classNameName="cart_item" key={index}>
                                  <td classNameName="product-name">
                                    {item.name}
                                    <strong classNameName="product-quantity">
                                  ...
                                  <td classNameName="product-total">
                                    <span classNameName="woocommerce-Price-amount amount">
                                      <bdi>
                                        <span classNameName="woocommerce-Price-currencySymbol">
                                          &#36;
                                        </span>
                                        {calculateSubtotal(
                                          quantities[item.id] || 1,
                            ...
                            <tfoot>
                              ...
                              <tr classNameName="shipping">
                                ...
                                <td data-title="Shipping">
                                  <ul
                                    id="shipping_method"
                                    classNameName="woocommerce-shipping-methods"
                                  >
                                    <li>
                                      <input
                                        type="hidden"
                          ...
                          <div
                            id="payment"
                            classNameName="woocommerce-checkout-payment"
                          >
      ...
      >
        <CheckoutForm amount={amount} onClick= {handlePlaceOrder}/>
      </Elements>
                              </li>
                            </ul>
